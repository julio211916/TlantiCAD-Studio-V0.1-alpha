...
* Proposed architecture: {path to `/generate-web-diagram` output}
* Plan validation: {path to `/plan-review <adr-file>` output}
* Change diff: {path to `/diff-review` output, if this ADR replaces/supersedes an existing design}
